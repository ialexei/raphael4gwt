...
public class GRDotChartTest1 extends AbstractRaphyTest {
	...
	public void test(Element parent) {
		...
		org.sgx.raphael4gwt.gtest.gallery.tests.DotChartTest1 test = new DotChartTest1(paper, width, height);
		test.test(); 
	}

	// test related information:
	public GRDotChartTest1() {
		super("GRDotChartTest1", "GRDotChartTest1");
	}
	...
	public Map<String, ExternalTextResource> getResources() {
		...
		m.put("DotChartTest1.java", RaphyTestResources.INSTANCE.GRDotChartTest1());
		return m;
	}
}
