...
public class LineChartTest1 extends AbstractRaphyTest{
	...
	public void test(Element parent) {
		...
		chart.add_line(Line.create().data(new Point[]{
			Point.create(1, 3222),
			Point.create(2, 1222).tooltip("The pitch bend value"),
			Point.create(3, 2222),
			Point.create(4, 4222),
			Point.create(5, 5222),
			Point.create(6, 2222),
		...
		chart.add_line(Line.create().data(
				new double[][] { { 1, 8906 }, { 2, 5693 }, { 3, 5840 }, { 4, 1043 }, { 5, 1455 },
						{ 6, 2646 }, { 7, 2489 } }
			)			
			.options(LineOpts.create().fill_area(true).area_color("#ed2233"))
		); 
		chart.draw();
