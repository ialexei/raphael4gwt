//from https://raw.github.com/sentience/g.raphael/9a4ae7d85f8330da7cca3fa438792edb491ac703/g.radar.js
//https://github.com/DmitryBaranovskiy/g.raphael/pull/136
 ...
 * Licensed under the MIT (http://www.opensource.org/licenses/mit-license.php) license.
 */
Raphael.fn.radar = function (cx, cy, r, values, opts) { //sgurin fix here for old gr namespace
    opts = opts || {};
    var paper = this,			
	...
	middle_point = this.disc(cx, cy, 5).attr({stroke: opts.meshcolor, fill: opts.meshcolor, "stroke-width": opts.meshwidth});
	if (opts.helplines){
	...
	for (var i = 0; i < len; i++) {
		arms[i].point = this.disc(arms[i].x, arms[i].y, opts.discradius)
 ...
 /*   var legend = function (labels, otherslabel, mark, dir) {
        ...
        mark = paper.markers[mark && mark.toLowerCase()] || "disc";
        ...
        for (var i = 0; i < len; i++) {
            ...
            labels[j] = paper.labelise(labels[j], values[i], total);
