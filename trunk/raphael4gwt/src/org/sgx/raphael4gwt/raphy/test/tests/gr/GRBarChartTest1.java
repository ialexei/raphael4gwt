...
public class GRBarChartTest1 extends AbstractRaphyTest {
	...
	public void test(Element parent) {
		...
		org.sgx.raphael4gwt.gtest.gallery.tests.BarChartTest2 test = new BarChartTest2(paper, width, height);
		test.test(); 
	}

	// test related information:
	public GRBarChartTest1() {
		super("GRBarChartTest1", "GRBarChartTest1");
	}
	...
	public Map<String, ExternalTextResource> getResources() {
		...
		m.put("BarChartTest2.java", RaphyTestResources.INSTANCE.GRBarChartTest2());
		return m;
	}
}
