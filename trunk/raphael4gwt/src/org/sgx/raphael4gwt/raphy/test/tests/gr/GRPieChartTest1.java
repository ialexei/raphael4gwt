...
public class GRPieChartTest1 extends AbstractRaphyTest {
	...
	public void test(Element parent) {
		...
		org.sgx.raphael4gwt.gtest.gallery.tests.PieChartTest2 test = new PieChartTest2(paper, width, height);
		test.test(); 
	}

	// test related information:
	public GRPieChartTest1() {
		super("GRPieChartTest1", "GRPieChartTest1");
	}
	...
	public Map<String, ExternalTextResource> getResources() {
		...
		m.put("PieChartTest2.java", RaphyTestResources.INSTANCE.GRPieChartTest2());
		return m;
	}
}
